...
static void peripheralRSSICB( int8 newRSSI );
...
//    #endif
    ...
    GAPRole_SetParameter( GAPROLE_RSSI_READ_RATE, sizeof( uint16 ), &desired_conn_timeout );
  ...
  HBP_AddService( GATT_ALL_SERVICES);
