...
static KEYWORD_CODE hal_aci_data_t setup_msgs[NB_SETUP_MESSAGES] = SETUP_MESSAGES_CONTENT;
#else
static KEYWORD_CODE hal_aci_data_t setup_msgs[1] = {{0x00,{0x00}}};
#endif
static HAL_PLTF_MEM_RETENTION(radio_setup_state_t, host_setup_state, 0x0010)
